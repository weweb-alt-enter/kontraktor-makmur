...
<div class="container mx-auto px-4 py-8">
    <div class="grid lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-8">
            @if($inspirasi->gambar)
            <div class="rounded-2xl overflow-hidden shadow-xl -mt-20 relative z-10">
                <img src="{{ storage_url($inspirasi->gambar) }}" alt="{{ $inspirasi->judul }}"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div class="gallery-thumb aspect-square rounded-xl overflow-hidden"
                         onclick="openLightbox('{{ storage_url($gallery->image_path) }}', '{{ $gallery->caption ?? '' }}')">
